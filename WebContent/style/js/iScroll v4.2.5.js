...
(function(window, doc) {
	...
	iScroll.prototype = {
		...
		_move : function(e) {
			...
			// Lock direction
			/*
			 * if (that.options.lockDirection) { if (that.absDistX >
			 * that.absDistY + 5) { newY = that.y; deltaY = 0; } else if
			 * (that.absDistY > that.absDistX + 5) { newX = that.x; deltaX = 0; } }
			 */
			...
			// 鏂板姞 0813
			e.preventDefault();
			// if(newY >= -5 && newY <= 5){ e.preventDefault(); }
		},
