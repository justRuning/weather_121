...
<script>
	...
	$("#last").click(function() {
		$.post("./getZaojian", {
			...
			$("#day").text(data["day"]);
			$("#input").text(data["zaojian"]["content"])
		});
...
<div
	...
	<div id="strCount" class="alert alert-info"
		style="text-align: center; font-size: 20px;">当前字数：60字（一条短信）</div>
	<textarea id="input" class="form-control" rows="7"
		style="font-size: 20px; padding: 15px;">${strZaojian }</textarea>
