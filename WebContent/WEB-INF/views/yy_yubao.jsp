...
<div>
	<p
		...
		class="bg-success">12121预报更新</p>
</div>

<div style="padding: 10px 100px 10px;width:50%">
	<form class="bs-example bs-example-form" role="form">
		<div class="input-group input-group-lg">
			<span class="input-group-addon">检索词条</span>
			<input id="inputName" name="name" type="text" class="form-control" placeholder="请输入拼音首字母">
		</div><br>
		<ul id="tip" style="margin: 0; padding: 0;color:rgba(222, 131, 17, 0.92);font-size:17px"></ul>
	</form>
</div>
...
<c:forEach items="${forecasts}" var="forecast">
	...
	<div class="col-md-2 column ui-sortable"
		style="margin: 4px 70px 40px; height: 600px; width: 400px; overflow: auto;">
